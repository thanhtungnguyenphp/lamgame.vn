                    ...
                    <div class="author-fields">
                        <div class="form-group">
                            ...
                            <input type="text" name="author_name" required class="form-input" 
                                   placeholder="Tên của bạn" value="{{ session('author_name') }}">
                        </div>
                        <div class="form-group">
                            <label>Email <span class="required">*</span></label>
                            <input type="email" name="author_email" required class="form-input" 
                                   placeholder="Email của bạn" value="{{ session('author_email') }}">
                        </div>
                    </div>
                    <div class="form-help">
...
document.getElementById('postForm').addEventListener('submit', function(e) {
    ...
    // Save author info to session
    localStorage.setItem('author_name', document.querySelector('[name="author_name"]').value);
    localStorage.setItem('author_email', document.querySelector('[name="author_email"]').value);
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load author info from localStorage
    const authorName = localStorage.getItem('author_name');
    const authorEmail = localStorage.getItem('author_email');
    if (authorName) document.querySelector('[name="author_name"]').value = authorName;
    if (authorEmail) document.querySelector('[name="author_email"]').value = authorEmail;
});
</script>
@endpush
@endsection
