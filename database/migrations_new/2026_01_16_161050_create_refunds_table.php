...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('refunds', function (Blueprint $table) {
            ...
            $table->decimal('adjustment_refund', 12, 4)->nullable()->default(0);
            $table->decimal('base_adjustment_refund', 12, 4)->nullable()->default(0);
            $table->decimal('adjustment_fee', 12, 4)->nullable()->default(0);
            $table->decimal('base_adjustment_fee', 12, 4)->nullable()->default(0);
            ...
            $table->unsignedInteger('order_id')->nullable()->index('refunds_order_id_foreign');
            $table->timestamps();
        });
    }
