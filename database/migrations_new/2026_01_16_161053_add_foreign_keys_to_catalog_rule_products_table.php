...
return new class extends Migration
{
    ...
    {
        Schema::table('catalog_rule_products', function (Blueprint $table) {
            $table->dropForeign('catalog_rule_products_catalog_rule_id_foreign');
            $table->dropForeign('catalog_rule_products_channel_id_foreign');
            $table->dropForeign('catalog_rule_products_customer_group_id_foreign');
            $table->dropForeign('catalog_rule_products_product_id_foreign');
        });
    }
};
