...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('refund_items', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('parent_id')->nullable()->index('refund_items_parent_id_foreign');
            ...
            $table->unsignedInteger('order_item_id')->nullable()->index('refund_items_order_item_id_foreign');
            $table->unsignedInteger('refund_id')->nullable()->index('refund_items_refund_id_foreign');
