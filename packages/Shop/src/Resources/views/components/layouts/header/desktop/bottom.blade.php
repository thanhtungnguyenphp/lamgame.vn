...
<div class="flex min-h-[78px] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8">
    ...
    <div class="flex items-center gap-x-10 max-[1180px]:gap-x-5">
        ...
        {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottom.custom_menu.before') !!}

        <!-- Custom Menu -->
        <x-shop::layouts.header.custom-menu />

        {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottom.custom_menu.after') !!}
